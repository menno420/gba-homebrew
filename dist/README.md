...
| [`cindervault.gba`](cindervault.gba) | **v0.3 named species** (growth cut 2: one named species per depth — CINDER RAT / SOOT WISP / ASH HOUND / VAULT WRAITH / HOARD SENTINEL — each a distinct chase quirk on the plugged-in greedy step; proven per-quirk in `games/cindervault/proofs.sh` P4, vault-to-vault) · 2026-07-14 | 122,652 bytes | source tree of the Cindervault species commit (`games/cindervault/` at the same tree as this file); build is byte-deterministic (two clean builds, identical hash) | `f82781e71c3bdc24d4988db2d65ba345f7431a3dc714adfcf83ed92f5c931da5` |
