...
| [`wickroad.gba`](wickroad.gba) | **v0.1 prototype** (breadth game #11, the generative rung: market-route trading loop — five towns, four goods, a 30-day clock, and the aging-ledger hook; core loop proven by a committed 13-day winning route, the market-impact ladder, the stale-ink witness and the pass-closes fail state, all in `games/wickroad/proofs.sh`) · 2026-07-14 | 121,708 bytes | source tree of the Wickroad prototype commit (`games/wickroad/` at the same tree as this file); build is byte-deterministic (two clean builds, identical hash) | `40bef9425bd16ed44a806b1162290b57a0c98c317d66ae3253596265149530db` |
...
2026-07-14 arcade-refresh slice (Undertow v1.5, Drift Garden v1.4,
arcade bundle v1.2 — superseding the PR #109 cut, which superseded
the stale PR #85 cut).
