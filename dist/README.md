...
| [`deepcast.gba`](deepcast.gba) | **v0.3 seed-select score-attack** (growth cut 2: the title's seed line is a dial — UP/DOWN +-1, LEFT/RIGHT +-0x100, L/R +-0x10000 — same dialed seed = same lake, same fish; the dusk score card names the seed; boot seed unchanged, no dial = the v0.2 run; proven in `games/deepcast/proofs.sh` P4/P5) · 2026-07-14 | 132,700 bytes | source tree of the Deepcast seed-select commit (`games/deepcast/` at the same tree as this file); build is byte-deterministic (two clean builds, identical hash) | `2a7010697667132b2c89a24af1e1ba7f521d80dc0225df185aebadba9e88e457` |
