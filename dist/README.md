...
| [`shoal.gba`](shoal.gba) | **v0.4 star ratings proper** (growth rung 3: "star rating = fish saved" graded per water — live HUD stars, both end cards rated, losses grade too) · session 48 · 2026-07-13 | 126,616 bytes | source tree of the Shoal ratings commit (`games/shoal/` at the same tree as this file); build is byte-deterministic (two clean builds, identical hash) | `a3a9f7f934467fc9d804cfd82df9b3c6ec2b35fd339c2dc74ccf065a8568cf38` |
