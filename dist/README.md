...
| [`shoal.gba`](shoal.gba) | **v0.3 the gated run** (growth rung 2: static coral gates with offset gaps, R verb — funnel the school through; worst gate-active frame 71.2% CPU, gate pass in IWRAM) · session 47 · 2026-07-13 | 127,016 bytes | source tree of the Shoal gates commit (`games/shoal/` at the same tree as this file); build is byte-deterministic (two clean builds, identical hash) | `569bda9632583f11a2ad5354364f9e27286401cb8a9c780c33f774b71cfd8375` |
