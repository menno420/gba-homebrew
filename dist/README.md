...
| [`shoal.gba`](shoal.gba) | **v0.5 the tuned levels** (growth rung 4: four-level campaign on the L verb — per-level hunter/gate/knob/goal tunes, all proven winnable in one chain; worst frame 82.3%) · session 49 · 2026-07-13 | 127,880 bytes | source tree of the Shoal levels commit (`games/shoal/` at the same tree as this file); build is byte-deterministic (two clean builds, identical hash) | `9cd4873303f5bccca555fff98c7251475e7eeeca4e8c60e18871232faeaa7d9a` |
