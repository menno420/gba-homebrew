...
| [`clockwork-courier.gba`](clockwork-courier.gba) | **v0.3 the rush order** (growth rung 2: two parcels, the chute keeps hours — catch the 60-in-240 window or wait for it; SELECT verb, classic run untouched) · session 52 · 2026-07-13 | 122,112 bytes | source tree of the Courier chutes commit (`games/clockwork-courier/` at the same tree as this file); build is byte-deterministic (two clean builds, identical hash) | `e88a83a6527cf60ce0cee6e66daf61e662c8965985f025b5dd5b6d0ba7d9531a` |
