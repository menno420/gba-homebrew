...
| [`wickroad.gba`](wickroad.gba) | **v0.2 rumors** (growth cut 1: a fixed deterministic rumor deck — town criers telegraph future price shocks days ahead and the market then obeys them to the exact gold piece, making the ledger a forecasting tool; the shock is one more closed-form term of the v0.1 price law, no new RNG, and the forecast itself is proven in `games/wickroad/proofs.sh` P4 — foretold pinned before the shock, realized == foretold at the hit day, window passing — on top of the carried v0.1 P1-P3) · 2026-07-15 | 122,404 bytes | source tree of the Wickroad rumors commit (`games/wickroad/` at the same tree as this file); build is byte-deterministic (two clean builds, identical hash) | `ebcc10f1f5a6686664e51463b3a22b77d1651ccb69f3116075c7aef8bbe5fdea` |
