...
| [`clockwork-courier.gba`](clockwork-courier.gba) | **v0.4 the tower shifts** (growth rung 3: three new floors on the L verb — the high shelf, the night shift, the full round; every floor proven solvable and refused) · session 53 · 2026-07-13 | 122,540 bytes | source tree of the Courier levels commit (`games/clockwork-courier/` at the same tree as this file); build is byte-deterministic (two clean builds, identical hash) | `bed161b5b2b7c69a583b2c0b412f0c855c1a66cee44fb3458f5cd731c0ffc5e0` |
