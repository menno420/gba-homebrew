 ...
 * seeded mulberry32 RNG (seed via ?seed=N, else derived from load timing).
...
(function () {
  ...
  var seed = (seedParam !== null && seedParam !== "" && !isNaN(+seedParam))
    ? (+seedParam >>> 0) : defaultSeed();
  ...
  function render() {
    ...
    if (state === "title") {
      ...
      ctx.fillText("seed " + seed, W / 2, 370);
