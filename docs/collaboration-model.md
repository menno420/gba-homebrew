# gba-homebrew — game-lab Track B: original GBA homebrew on Butano — collaboration model
...
- Staleness review cadence: Every session close: standing ritual re-reads inbox at HEAD and overwrites control/status.md; session cards flag stale docs as flags; check --strict staleness triggers back this up
