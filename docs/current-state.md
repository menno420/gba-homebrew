...
| 11 | **Wickroad** (market-route trading, aging ledger) | GBA | v0.8 — named growth path COMPLETE (cuts 1–5 #142–#146); **crossroads arc** (2nd arc, `games/wickroad/ARC-CROSSROADS.md`): cut 1 THE JUNCTION PR #172 (branch roads + the L+R fork verb, WYRMHOLLOW off DUNWICK, +8 RNG draws, telemetry 52→56, proof P9); cut 2 THE SPRITE ART PASS in-progress (2026-07-16, DRAFT/held, stacked on #172): an authored `regular_bg` baked from the same sim state (`games/wickroad/graphics/`), glyphs on top, presentation-only — 56 telemetry words + 27 text lines + P1-P9 byte-identical; second `wr_art` mailbox + hardware pins in proof P10; crossroads cuts 3–4 (seed dial / best ledger) planned |
