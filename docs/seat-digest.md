# gba-homebrew — game-lab Track B: original GBA homebrew on Butano — seat digest
...
- `any` · **Merging own PRs is NOT a wall** (corrected 2026-07-18): merging own/green PRs, arming auto-merge, and draft→ready flips are normal agent actions (proven by…
