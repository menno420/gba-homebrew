...
#
# RUNG-5 CLOCK RE-BASE: enabling the audio engine adds a constant
# per-frame mixing cost, which tipped the run-transition spike frame
# (the 50-sprite spawn, the only >100% frame) across ONE more vblank
# in every water — boot-lags are now calm 2 / hungry 3 / gated+levels
# 3 (was 1/2/2). Every post-press span and every post-transition
# assert frame moved +1; EVERY game-state literal carried verbatim
# (new(hw) == old(hw-1), proven by the ±1-row-offset diff — the #102
# card's method, applied suite-wide).
#
...
# Rung 5 audio evidence (docs/capabilities.md method): cumulative
# decision counters + the maxmod mixer-memory activity word (count of
# nonzero u32 words — 0 exactly when the mixer is silent).
WA='--watch h:gl_audio_hook:8 --watch-nonzero mix:maxmod_mixing_buffer:0x420'

echo "== P1: boot + title =="
H "$OUT/p1.png" --frames 70 $W $WA --keys 30-32:B \
  --assert-watch 60:h:5:eq:1 \
...
H "$OUT/p2.png" --frames 1310 $W --keys 10-12:START \
  --assert-watch 401:t:2:eq:1 \
  --assert-watch 401:t:6:eq:49 \
  --assert-watch 401:t:7:eq:1 \
  --assert-watch 401:t:8:eq:91 \
  --assert-watch 401:t:9:eq:59 \
  --assert-watch 401:t:10:eq:30768 \
  --assert-watch 401:t:11:eq:14690 \
  --assert-watch 401:t:15:eq:389 \
  --assert-watch 401:t:16:eq:0 \
  --assert-watch 401:t:17:eq:0 \
  --assert-watch 401:t:4:eq:2159 \
  --assert-watch 401:t:5:eq:2853 \
  --assert-watch 401:t:5:lt:4096 \
  --assert-watch 1200:t:6:eq:47 \
  --assert-watch 1200:t:7:eq:3 \
  --assert-watch 1200:t:8:eq:85 \
  --assert-watch 1200:t:9:eq:57 \
  --assert-watch 1200:t:5:eq:2853 \
  --assert-watch 1200:t:5:lt:4096 \
  --assert-watch 1300:t:7:eq:5 \
  --assert-watch 1300:t:16:eq:0 \
  --assert-watch 1300:t:24:eq:0 \
  --assert-text "1300:SAVED 5/40 -"

echo "== P3: hungry idle — the predator pass, carried =="
H "$OUT/p3.png" --frames 1710 $W --keys 10-12:SELECT \
  --assert-watch 321:t:16:eq:1 \
  --assert-watch 321:t:17:eq:2 \
  --assert-watch 321:t:18:eq:176 \
  --assert-watch 321:t:19:eq:40 \
  --assert-watch 321:t:20:eq:176 \
  --assert-watch 321:t:21:eq:120 \
  --assert-watch 401:t:5:eq:3126 \
  --assert-watch 401:t:5:lt:4096 \
  --assert-watch 1421:t:17:eq:8 \
  --assert-watch 1700:t:17:eq:10 \
  --assert-watch 1700:t:6:eq:37 \
  --assert-watch 1700:t:7:eq:3 \
  --assert-watch 1700:t:5:eq:3126 \
  --assert-watch 1700:t:5:lt:4096 \
  --assert-watch 1700:t:24:eq:0
...
GATED_WIN_ROUTE='--keys 10-12:R --keys 13-33:RIGHT --keys 13-43:DOWN --keys 43-353:A --keys 43-73:LEFT --keys 73-111:RIGHT --keys 111-149:LEFT --keys 149-187:RIGHT --keys 187-225:LEFT --keys 225-263:RIGHT --keys 263-301:LEFT --keys 301-339:RIGHT --keys 353-385:LEFT --keys 353-411:UP --keys 411-851:A --keys 411-439:DOWN --keys 439-467:UP --keys 467-495:DOWN --keys 495-523:UP --keys 523-551:DOWN --keys 551-579:UP --keys 579-607:DOWN --keys 607-635:UP --keys 635-663:DOWN --keys 663-691:UP --keys 691-719:DOWN --keys 719-747:UP --keys 747-775:DOWN --keys 775-803:UP --keys 803-831:DOWN --keys-pattern 411-851:8:1:RIGHT --keys 851-881:LEFT --keys 851-882:DOWN --keys 882-1161:A --keys 882-912:LEFT --keys 912-950:RIGHT --keys 950-988:LEFT --keys 988-1026:RIGHT --keys 1026-1064:LEFT --keys 1064-1102:RIGHT --keys 1102-1140:LEFT --keys 1140-1161:RIGHT --keys 1161-1196:LEFT --keys 1161-1219:UP --keys 1226-1666:A --keys 1226-1254:DOWN --keys 1254-1282:UP --keys 1282-1310:DOWN --keys 1310-1338:UP --keys 1338-1366:DOWN --keys 1366-1394:UP --keys 1394-1422:DOWN --keys 1422-1450:UP --keys 1450-1478:DOWN --keys 1478-1506:UP --keys 1506-1534:DOWN --keys 1534-1562:UP --keys 1562-1590:DOWN --keys 1590-1618:UP --keys 1618-1646:DOWN --keys-pattern 1226-1666:8:1:RIGHT --keys 1801-1808:LEFT --keys 1801-1816:DOWN --keys 1816-2101:A --keys 1816-1830:DOWN --keys 1830-1855:UP --keys 1855-1880:DOWN --keys 1880-1905:UP --keys 1905-1930:DOWN --keys 1930-1955:UP --keys 1955-1980:DOWN --keys 1980-2005:UP --keys 2005-2030:DOWN --keys 2030-2055:UP --keys 2055-2080:DOWN --keys 2080-2101:UP --keys-pattern 1816-2101:6:1:RIGHT --keys 2101-2194:LEFT --keys 2101-2123:DOWN --keys 2194-2451:A --keys 2194-2232:RIGHT --keys 2232-2270:LEFT --keys 2270-2308:RIGHT --keys 2308-2346:LEFT --keys 2346-2384:RIGHT --keys 2384-2422:LEFT --keys 2422-2451:RIGHT --keys 2451-2479:LEFT --keys 2451-2511:UP --keys 2516-2956:A --keys 2516-2544:DOWN --keys 2544-2572:UP --keys 2572-2600:DOWN --keys 2600-2628:UP --keys 2628-2656:DOWN --keys 2656-2684:UP --keys 2684-2712:DOWN --keys 2712-2740:UP --keys 2740-2768:DOWN --keys 2768-2796:UP --keys 2796-2824:DOWN --keys 2824-2852:UP --keys 2852-2880:DOWN --keys 2880-2908:UP --keys 2908-2936:DOWN --keys 2936-2956:UP --keys-pattern 2516-2956:8:1:RIGHT --keys 2956-2971:DOWN --keys 2971-3101:A --keys 2971-2985:DOWN --keys 2985-3010:UP --keys 3010-3035:DOWN --keys 3035-3060:UP --keys 3060-3085:DOWN --keys 3085-3101:UP --keys-pattern 2971-3101:6:1:RIGHT --keys 3101-3173:LEFT --keys 3181-3561:A --keys 3181-3201:UP --keys 3201-3229:DOWN --keys 3229-3257:UP --keys 3257-3285:DOWN --keys 3285-3313:UP --keys 3313-3341:DOWN --keys 3341-3369:UP --keys 3369-3397:DOWN --keys 3397-3425:UP --keys 3425-3453:DOWN --keys 3453-3481:UP --keys 3481-3509:DOWN --keys 3509-3537:UP --keys 3537-3561:DOWN --keys-pattern 3181-3561:8:1:RIGHT --keys 3601-3603:START'

P4_ASSERTS=(
  --assert-watch 3541:h:0:eq:1
  --assert-watch 3541:h:1:eq:40
  --assert-watch 3541:h:2:eq:0
  --assert-watch 3541:h:3:eq:1
  --assert-watch 3541:h:4:eq:0
  --assert-watch 3545:mix:0:gt:0
  --assert-watch 3651:h:0:eq:2
  --assert-watch 101:t:16:eq:2
  --assert-watch 201:t:24:eq:3
  --assert-watch 801:t:7:eq:9
  --assert-watch 1701:t:7:eq:25
  --assert-watch 2001:t:7:eq:30
  --assert-watch 3101:t:7:eq:39
  --assert-watch 3541:t:2:eq:2
  --assert-watch 3541:t:7:eq:40
  --assert-watch 3541:t:6:eq:10
  --assert-watch 3541:t:15:eq:3519
  --assert-watch 3541:t:16:eq:2
  --assert-watch 3541:t:17:eq:0
  --assert-watch 3541:t:22:eq:0
  --assert-watch 3541:t:23:eq:0
  --assert-watch 3541:t:5:eq:2989
  --assert-watch 3541:t:5:lt:4096
  --assert-text "3561:THE SHOAL IS HOME"
  --assert-text "3561:SAVED 40/50"
  --assert-text "3561:CLOCK 58s (3519 FRAMES)"
  --assert-text "3561:THE TIDE THANKS YOU"
  --assert-text "1701:SAVED 25/40 *"
  --assert-text "2001:SAVED 30/40 **"
  --assert-text "3561:RATING ***"
  --assert-watch 3651:t:2:eq:1
  --assert-watch 3651:t:16:eq:0
  --assert-watch 3651:t:17:eq:0
  --assert-watch 3651:t:6:eq:50
  --assert-watch 3651:t:7:eq:0
  --assert-watch 3651:t:24:eq:0
)

echo "== P4: THE GATED RUN — the committed funnel wins (run 1) =="
H "$OUT/p4.png" --frames 3670 $W $WA $GATED_WIN_ROUTE \
  --watch-log "$OUT/p4-run1.csv" --shot "3561:$OUT/p4-win.png" \
  "${P4_ASSERTS[@]}"

echo "== P4: run 2 (must be byte-identical) =="
H "$OUT/p4b.png" --frames 3670 $W $WA $GATED_WIN_ROUTE \
...
H "$OUT/p5.png" --frames 1310 $W --keys 10-12:R \
  --assert-watch 61:t:16:eq:2 \
  --assert-watch 61:t:24:eq:1 \
  --assert-watch 1300:t:6:eq:50 \
  --assert-watch 1300:t:7:eq:0 \
  --assert-watch 1300:t:8:eq:70 \
  --assert-watch 1300:t:9:eq:62 \
  --assert-watch 1300:t:17:eq:0 \
  --assert-watch 1300:t:5:eq:3019 \
  --assert-watch 1300:t:5:lt:4096
...
GRADED_LOSS_ROUTE='--keys 10-12:SELECT --keys 14-44:DOWN --keys 14-59:RIGHT --keys 62-92:UP --keys 102-3462:A --keys 102-132:DOWN --keys 162-192:UP --keys 222-252:DOWN --keys 282-312:UP --keys 342-372:DOWN --keys 402-432:UP --keys 462-492:DOWN --keys 522-552:UP --keys 582-612:DOWN --keys 642-672:UP --keys 702-732:DOWN --keys 762-792:UP --keys 822-852:DOWN --keys 882-912:UP --keys 942-972:DOWN --keys 1002-1032:UP --keys 1062-1092:DOWN --keys 1122-1152:UP --keys 1182-1212:DOWN --keys 1242-1272:UP --keys 1302-1332:DOWN --keys 1362-1392:UP --keys 1422-1452:DOWN --keys 1482-1512:UP --keys 1542-1572:DOWN --keys 1602-1632:UP --keys 1662-1692:DOWN --keys 1722-1752:UP --keys 1782-1812:DOWN --keys 1842-1872:UP --keys 1902-1932:DOWN --keys 1962-1992:UP --keys 2022-2052:DOWN --keys 2082-2112:UP --keys 2142-2172:DOWN --keys 2202-2232:UP --keys 2262-2292:DOWN --keys 2322-2352:UP --keys 2382-2412:DOWN --keys 2442-2472:UP --keys 2502-2532:DOWN --keys 2562-2592:UP --keys 2622-2652:DOWN --keys 2682-2712:UP --keys 2742-2772:DOWN --keys 2802-2832:UP --keys 2862-2892:DOWN --keys 2922-2952:UP --keys 2982-3012:DOWN --keys 3042-3072:UP --keys 3102-3132:DOWN --keys 3162-3192:UP --keys 3222-3252:DOWN --keys 3282-3312:UP --keys 3342-3372:DOWN --keys 3402-3432:UP'

P6_ASSERTS=(
  --assert-watch 3451:h:2:eq:16
  --assert-watch 3451:h:3:eq:0
  --assert-watch 3451:h:4:eq:1
  --assert-watch 3445:mix:0:gt:0
  --assert-watch 101:t:16:eq:1
  --assert-watch 1201:t:7:eq:6
  --assert-watch 1201:t:17:eq:6
  --assert-watch 3451:t:2:eq:3
  --assert-watch 3451:t:7:eq:6
  --assert-watch 3451:t:17:eq:16
  --assert-watch 3451:t:15:eq:3420
  --assert-watch 3451:t:24:eq:0
  --assert-watch 3451:t:5:eq:3187
  --assert-watch 3451:t:5:lt:4096
  --assert-text "3481:THE SHOAL SCATTERED"
  --assert-text "3481:EATEN 16  SAVED 6"
  --assert-text "3481:CLOCK 57s (3420 FRAMES)"
  --assert-text "3481:KEEP THE SCHOOL TIGHT"
  --assert-text "3481:RATING -"
)

echo "== P6: a graded loss — the scattered shoal still banks its stars (run 1) =="
H "$OUT/p6.png" --frames 3530 $W $WA $GRADED_LOSS_ROUTE \
  --watch-log "$OUT/p6-run1.csv" --shot "3481:$OUT/p6-card.png" \
  "${P6_ASSERTS[@]}"

echo "== P6: run 2 (must be byte-identical) =="
H "$OUT/p6b.png" --frames 3530 $W $WA $GRADED_LOSS_ROUTE \
...
P7_ASSERTS=(
  ...
  --assert-text "2921:L1 THE SHALLOWS - L: NEXT"
  --assert-text "2921:RATING ***"
  --assert-text "2921:SAVED 40/50"
...
H "$OUT/p7.png" --frames 8910 $W $WA $LEVELS_CHAIN_ROUTE \
  --watch-log "$OUT/p7-run1.csv" --shot "8770:$OUT/p7-l4-card.png" \
  "${P7_ASSERTS[@]}"

echo "== P7: run 2 (must be byte-identical) =="
H "$OUT/p7b.png" --frames 8910 $W $WA $LEVELS_CHAIN_ROUTE \
